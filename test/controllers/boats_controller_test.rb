...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { containers: @boat.containers, location: @boat.location, name: @boat.name, user_id: @boat.user_id } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { containers: @boat.containers, location: @boat.location, name: @boat.name, user_id: @boat.user_id } }
